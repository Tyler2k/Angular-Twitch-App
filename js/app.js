...
twitchApp.controller("mainController", ["$scope", "$resource", "$routeParams", "$filter", function ($scope, $resource, $routeParams, $filter) {
   ...
   $scope.channel = [{name:"BobRoss"},{name:"OgamingSC2"}, {name: "NALCS1"}, {name:"PokerCentral"}, {name:"DansGaming"}, {name:"Resttpowered"}, {name:"Summit1g"}, {name:"Steel_Tv"}, {name:"ProfessorBroman"}, {name:"StreamerHouse"}, {name:"DotaMajor"}, {name:"Stewie2K"}];
